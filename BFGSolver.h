...
private:
	...
	double ArmijoBackTrack(IFunction& func, 
		double fXk, VectorXd& Xk, VectorXd& gradXk, 
		VectorXd& Dk, VectorXd& Xk1, VectorXd& gradXk1, double alpha, double alphaCoeff, double delta)
	{
...
public:
	...
	int solve(IFunction& func, VectorXd& Xk, double& fx)
	{
		// Step 1 init
		fx = 0;
		int size = func.size;
